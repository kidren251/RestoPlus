...
const ACCES_RAPIDES = [
  ...
  { id: "fiches_vip", label: "Réservations du soir", numero: "03" },
] as const;
...
export function AccueilScreen({
  ...
  const badges: Record<string, string | undefined> = {
    checklists:
      checklistsEnAttente > 0 ? `${checklistsEnAttente} en attente` : undefined,
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View>
        {ACCES_RAPIDES.map((item) => (
          ...
          >
            ...
            {badges[item.id] && (
              <Text style={styles.rowBadge}>{badges[item.id]}</Text>
            )}
      ...
      {/* Pied de page : prenom utilisateur */}
      <View style={styles.footer}>
        <Text style={styles.footerText}>Bonjour, {prenomUtilisateur}</Text>
      </View>
    </ScrollView>
  );
}
